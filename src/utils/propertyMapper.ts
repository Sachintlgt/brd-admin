...
export const mapFormToProperty = (values: PropertyFormValues) => {
  ...
  return {
    ...
    postalCodeSuffix: values.postalCodeSuffix,
    viewportNortheastLat: values.viewportNortheastLat,
    viewportNortheastLng: values.viewportNortheastLng,
    viewportSouthwestLat: values.viewportSouthwestLat,
    viewportSouthwestLng: values.viewportSouthwestLng,
    zoom: values.zoom,
